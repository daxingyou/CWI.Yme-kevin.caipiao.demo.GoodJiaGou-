...
namespace Yme.Mcp.WinServ.Busy.TimerCtrl
{
    ...
    /// 客户日报定时服务
    /// </summary>
    public class CustomerDayRptTimer : BaseTimer
    {
        //执行分钟
        ...
        public override void Timer_Elapsed()
        {
            ...
            if (now == runTimer)
            {
                LogUtil.Info("开始生成客户日报...");
                SingleInstance<ReportBLL>.Instance.CreateCustomerDayReport(now.AddDays(-1).Date);
            }
            ...
            //{
            //    LogUtil.Info("开始生成客户日报...");
            //    SingleInstance<ReportBLL>.Instance.CreateCustomerDayReport(d.ToDate());
            //}
        }
    }
}
