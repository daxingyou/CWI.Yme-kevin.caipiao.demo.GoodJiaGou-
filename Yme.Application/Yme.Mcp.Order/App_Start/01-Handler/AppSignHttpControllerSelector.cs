...
namespace Yme.Mcp.Order.Handel
{
    /// <summary>
    /// 控制器选择器类
    /// </summary>
    public class AppSignHttpControllerSelector : IHttpControllerSelector
    {
        ...
        /// 控制器完整类名前缀
        /// </summary>
        public const string ControllerPrefix = "Yme.Mcp.Order.Controllers";
        ...
        private static ConcurrentDictionary<string, Type> GetControllerTypes()
        {
           // var assemblies = AppDomain.CurrentDomain.GetAssemblies();
            Assembly[] assemblies = new Assembly[] { AppDomain.CurrentDomain.Load("Yme.Mcp.Order") }; //指定程序集
        ...
        private HttpControllerDescriptor GetApiController(HttpRequestMessage request)
        {
            ...
            var appSign = "Api";//GetAppSign(request);
