...
namespace Yme.Util.Extension
{
    ...
    public static partial class Extensions
    {
        ...
        /// <returns></returns>
        public static string SplitMoblie(this string phone)
        {
            if (phone.Length >= 11)
            {
                return string.Format("{0}-{1}-{2}", phone.Substring(0, 3), phone.Substring(3, 4), phone.Substring(7, 4));
            }
            else
            {
                return phone;
        ...
        /// <param name="phone"></param>
        /// <returns></returns>
        public static string HideMoblie(this string phone)
        {
            if (phone.Length >= 7)
            {
        ...
        /// <returns></returns>
        public static bool IsNumBool(this string strNumber)
        {
            string pet = @"^[0,1]{1}$";
