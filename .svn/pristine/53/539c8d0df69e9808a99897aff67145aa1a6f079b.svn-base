/*! art-template@4.0.0-beta1 | https://github.com/aui/art-template */
!function (e, t) {
  // "object" == typeof exports && "object" == typeof module ? module.exports = t(require("fs"), require("path")) : "function" == typeof define && define.amd ? define(["fs", "path"], t) : "object" == typeof exports ? exports.template = t(require("fs"), require("path")) : 
  e.template = t(e.fs, e.path);
}(this, function (e, t) {
  return function (e) {
    function t(r) {
    ...
    u = function e(t) {
      ...
      'object' === (void 0 === t ? 'undefined' : r(t)) ? n = t : n.source = t,
      n = i.$extend(n),
      t = n.source;
      var u = n.debug,
      s = n.filename,
      ...
      h = function t(r) {
        try {
          ...
          if (!n.compileDebug) return n.cache = null,
          n.compileDebug = !0,
          e(n) (r);
          if (n.bail) throw t;
          return u(t) ()
  ...
  function (e, t, n) {
    ...
    e.exports = !1;
    try {
      e.exports = '[object process]' === Object.prototype.toString.call(global.process)
    } catch (e) {
    }
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    function (e, t, n) {
      ...
      var r = function (e) {
        ...
        return function e(t) {
          return 'string' != typeof t && (t = 'function' == typeof t ? e(t.call(t))  : null === t ? '' : JSON.stringify(t) || ''),
          t
    ...
    function (e, t, n) {
      ...
      o = function (e) {
        if (r) {
          return n(19).readFileSync(e, 'utf8')
        }
    ...
    function (e, t, n) {
        ...
        use: function (e, t, n, r) {
          ...
          switch ('#' === t && h('#value', '@value'), p) {
            ...
            case 'if':
              ...
              break;
            case 'else':
              'if' === c[0] ? (c.shift(), r = '}else if(' + c.join('') + '){')  : r = '}else{';
              break;
            case '/if':
              r = '}';
              break;
            ...
            default:
              ...
              } else u.imports[p] ? (h('filterName value', 'value | filterName'), r = p + '(' + c.join(',') + ')', f = 'raw')  : r = '' + p + c.join('');
              f || (f = 'escape')
          }
          return a.code = r,
          a.output = f,
      ...
      o = function (e) {
        for (var t = 0, n = e.shift(), r = [
          ...
          var o = e[t],
          i = o.type;
          'whitespace' !== i && 'comment' !== i ? ('punctuator' === n.type && ']' !== n.value || 'punctuator' === i ? r[r.length - 1].push(o)  : r.push([o]), n = o, t++)  : t++
        }
    ...
    function (e, t, n) {
      ...
      p = function () {
        function e(t) {
          ...
          t.compileDebug && this.importContext('$line'),
          this.getTplTokens(u, t.rules, this).forEach(function (e) {
        ...
        return i(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var h = this.getEsTokens(l);
              this.getVariables(h).forEach(function (e) {
          ...
          },
          {
            ...
            value: function () {
              ...
              try {
                ...
                for (var p = 0, h = 0, m = 0, v = r; p < n.length; ) {
                  var y = n[p];
    ...
    function (e, t, n) {
      ...
      u = function (e) {
        return e.match(r).map(function (e) {
          ...
          return 'name' === e.type && i(e.value) && (e.type = 'keyword'),
          e
        })
      };
      e.exports = u
    ...
    function (e, t, n) {
      ...
      var r = function (e, t, n) {
        for (var r = [
          ...
          if ('string' === r[u].type) {
            for (var s = r[u].line, a = r[u].start, c = r[u].end, l = r[u].value.match(i), f = [
            ], p = 0; p < l.length; p++) {
              var h = l[p];
              e.test.lastIndex = 0;
              var m = e.test.exec(h),
              v = m ? 'expression' : 'string',
              y = f[f.length - 1],
              d = y || r[u],
              b = d.value;
              a = d.line === s ? y ? y.end : a : b.length - b.lastIndexOf('\n') - 1,
              c = a + h.length;
              var g = {
                type: v,
                value: h,
              ...
              if ('string' === v) y && 'string' === y.type ? (y.value += h, y.end += h.length)  : f.push(g);
               else {
    ...
    function (e, t, n) {
      ...
      u = n(1),
      s = function (e, t) {
        return 'object' === (void 0 === t ? 'undefined' : r(t)) ? o({
          filename: e
        }, t)  : i({
          filename: e,
          source: t
