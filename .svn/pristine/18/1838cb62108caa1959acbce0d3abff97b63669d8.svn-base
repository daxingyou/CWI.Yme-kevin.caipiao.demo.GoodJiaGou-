...
window.LCalendar = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            this.confirm = params.confirm ? params.confirm: function(){};
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                ...
                if (/^\d{4}-\d{1,2}-\d{1,2}$/.test(_self.trigger.value)) {
                    ...
                    dateArr.yy = _self.maxY - _self.minY;
                }
            ...
            function finishMobileDate(e) {
                ...
                if (_self.trigger.nodeName.toLowerCase() === "input") {
                    ...
                    _self.trigger.innerText = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
                }
                _self.confirm.call(_self.trigger, (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd);
            ...
            function finishMobileDateTime(e) {
              ...
              if (_self.trigger.nodeName.toLowerCase() === "input") {
                    ...
                    _self.trigger.innerText = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd + " " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
                }
            ...
            function finishMobileTime(e) {
                ...
                if (_self.trigger.nodeName.toLowerCase() === "input") {
                    ...
                    _self.trigger.innerText = (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm;
                }
                closeMobileCalendar(e);
            }
        ...
        setOption: function(options){
            if (options.minDate) {
                var minArr = options.minDate.split('-');
                this.minY = ~~minArr[0];
                this.minM = ~~minArr[1];
                this.minD = ~~minArr[2];
            }
            ...
            if (options.maxDate) {
                var maxArr = options.maxDate.split('-');
                this.maxY = ~~maxArr[0];
                this.maxM = ~~maxArr[1];
                this.maxD = ~~maxArr[2];
            }
