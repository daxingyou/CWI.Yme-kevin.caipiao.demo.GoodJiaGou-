...
namespace Yme.Mcp.Demo.Handel
{
    ...
    public class AppSignHttpControllerSelector : IHttpControllerSelector
    {
        ...
        /// 控制器完整类名前缀
        /// </summary>
        public const string ControllerPrefix = "Yme.Mcp.Demo.Controllers";
        ...
        private static ConcurrentDictionary<string, Type> GetControllerTypes()
        {
           // var assemblies = AppDomain.CurrentDomain.GetAssemblies();
            Assembly[] assemblies = new Assembly[] { AppDomain.CurrentDomain.Load("Yme.Mcp.Demo") }; //指定程序集
